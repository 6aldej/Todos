  ...
  <div class="container">
    <div class="col-sm-10">
      ...
      <div  v-if="showConfirmation">
        <b-alert variant="success" show>{{confirmationMessage}}
          <button
            v-on:click="showConfirmation = false"
            type="button" class="close" data-dismiss="alert"
            aria-label="Close"
            title="Нажми на меня, чтобы скрыть уведомление">
      ...
      <button type="button"
              ...
              title="Нажми на меня, чтобы добавить новую задачу"
      ...
      <div>
        <b-alert show>
          <a class="alert-link">Выполненных задач: {{CompletedTodos()}}✔</a>
        </b-alert>

        <b-alert show variant="danger">
          <a class="alert-link">Невыполненных задач: {{NotCompletedTodos()}}✖</a>
        </b-alert>
      </div>
